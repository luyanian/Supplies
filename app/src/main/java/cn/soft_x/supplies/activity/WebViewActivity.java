...
public class WebViewActivity extends BaseActivity {
    ...
    private void initIntent() {
        ...
        orderId = intent.getStringExtra(Constant.WEB_ORDER_ID);
    ...
    public class JsInterFace {
        ...
        public String getUserID() {
            ...
            if (!TextUtils.isEmpty(Constant.USER_ID)) {
                ...
                if (Cfg.loadStr(WebViewActivity.this, Constant.SH_USER_ID).equals("defaults")
                    ...
                    sb.append("我没有USER_ID,别找我要啦！");
                    Logger.i("sb->" + sb.toString());
                    return "我没有USER_ID,别找我要啦！";
                } else {
                    sb.append(Cfg.loadStr(WebViewActivity.this, Constant.SH_USER_ID));
                    Logger.i("sb->" + sb.toString());
        ...
        public String appyhmc() {
            if (!TextUtils.isEmpty(Constant.USER_NAME)) {
                ...
                if (Cfg.loadStr(WebViewActivity.this, Constant.USER_NAME).equals("defaults")
                        || TextUtils.isEmpty(Cfg.loadStr(WebViewActivity.this, Constant.USER_NAME))) {
                    return "我没有USER_ID,别找我要啦！";
                } else {
                    return Cfg.loadStr(WebViewActivity.this, Constant.USER_NAME);
                }
            }
        }
        /**
        ...
        public void goActivity(String type) {
            ...
            switch (type) {
                ...
                case INVITATION_AC:
                    ...
                    break;
                case TRUCK_AC:
                    intent = new Intent(WebViewActivity.this, TruckActivity.class);
                    startActivity(intent);
                    break;
            }
        }
